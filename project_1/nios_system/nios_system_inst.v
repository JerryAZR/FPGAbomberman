	nios_system u0 (
		...
		.keya_export            (<connected-to-keya_export>),            //            keya.export
		.keyb_export            (<connected-to-keyb_export>),            //            keyb.export
		.keyc_export            (<connected-to-keyc_export>),            //            keyc.export
		.keyd_export            (<connected-to-keyd_export>),            //            keyd.export
		.keye_export            (<connected-to-keye_export>),            //            keye.export
		.keyf_export            (<connected-to-keyf_export>),            //            keyf.export
		...
		.rom_clk_clk            (<connected-to-rom_clk_clk>),            //         rom_clk.clk
